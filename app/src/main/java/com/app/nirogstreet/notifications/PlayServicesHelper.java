...
/**
 * Created by Preeti on 10-02-2017.
 */
  ...
  /*  private static final String PROPERTY_APP_VERSION = "appVersion";
    ...
    *//**
    ...
    private void subscribeToPushNotifications(String registrationID) {
        ...
        subscription.setEnvironment(AppUrl.environment);
        //
        String deviceId;
    ...
    @Override public void onSuccess(ArrayList<QBSubscription> subscriptions, Bundle args) {
    Log.d(TAG, "subscribed");
    }

    @Override public void onError(QBResponseException error) {
