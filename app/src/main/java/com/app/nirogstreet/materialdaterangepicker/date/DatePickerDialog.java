...
package com.app.nirogstreet.materialdaterangepicker.date;
...
import com.app.nirogstreet.materialdaterangepicker.HapticFeedbackController;
import com.app.nirogstreet.materialdaterangepicker.TypefaceHelper;
import com.app.nirogstreet.materialdaterangepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
        OnClickListener, com.app.nirogstreet.materialdaterangepicker.date.DatePickerController {
    ...
    private com.app.nirogstreet.materialdaterangepicker.date.AccessibleDateAnimator mAnimator;
    ...
    private com.app.nirogstreet.materialdaterangepicker.date.DayPickerView mDayPickerView;
    private com.app.nirogstreet.materialdaterangepicker.date.YearPickerView mYearPickerView;
    ...
    private com.app.nirogstreet.materialdaterangepicker.date.SimpleDayPickerView mDayPickerViewEnd;
    private com.app.nirogstreet.materialdaterangepicker.date.YearPickerView mYearPickerViewEnd;
    private com.app.nirogstreet.materialdaterangepicker.date.AccessibleDateAnimator mAnimatorEnd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDayPickerView = new com.app.nirogstreet.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerView = new com.app.nirogstreet.materialdaterangepicker.date.YearPickerView(activity, this);
        mDayPickerViewEnd = new com.app.nirogstreet.materialdaterangepicker.date.SimpleDayPickerView(activity, this);
        mYearPickerViewEnd = new com.app.nirogstreet.materialdaterangepicker.date.YearPickerView(activity, this);
        ...
        mAnimator = (com.app.nirogstreet.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator);
        mAnimatorEnd = (com.app.nirogstreet.materialdaterangepicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator_end);
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                com.app.nirogstreet.materialdaterangepicker.date.MonthAdapter.CalendarDay calendarDay;
                if(tabId.equals("start")){
                    calendarDay = new com.app.nirogstreet.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar.getTimeInMillis());
                    mDayPickerView.goTo(calendarDay,true,true,false);
                }
                else{
                    calendarDay = new com.app.nirogstreet.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd.getTimeInMillis());
    ...
    @Override
    public com.app.nirogstreet.materialdaterangepicker.date.MonthAdapter.CalendarDay getSelectedDay() {
        if(tabHost.getCurrentTab()==0){
            return new com.app.nirogstreet.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendar);
        }else{
            return new com.app.nirogstreet.materialdaterangepicker.date.MonthAdapter.CalendarDay(mCalendarEnd);
        }
