...
public class AppointmentParser {
    public static ArrayList<AppointmentModel> appointmentModels(JSONArray jsonObject) {
        ...
        try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            appointmentModels.add(new AppointmentModel(patient_detail, appointment_id, id, doctor_id, clinic_detail, coupon_id, date, time, status, createdOn, updatedOn, appointment_with, otp_verification, is_verified, reschedule_appointment_id, discount, fee, total));
                        }
