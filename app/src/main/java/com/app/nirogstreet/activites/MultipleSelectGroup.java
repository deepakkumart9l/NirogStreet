 ...
 */
public class MultipleSelectGroup extends Activity

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SesstionManager(MultipleSelectGroup.this);
        ...
        imageLoader = new ImageLoader(MultipleSelectGroup.this);
        circularProgressBar = (CircularProgressBar) findViewById(R.id.circularProgressBar);
        ...
        linearLayoutManager = new LinearLayoutManager(MultipleSelectGroup.this);
                        ...
                        timer.schedule(
                                new TimerTask() {
                                    ...
                                    public void run() {
                                        ...
                                        (MultipleSelectGroup.this).runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                totalFeeds = new ArrayList<>();
...

                    {
                        ...
                        if (searchModels != null && searchModels.size() > 0) {
                            ...
                            if (searchAdapterMultiSelect == null && totalFeeds.size() > 0) {
                                ...
                                searchAdapterMultiSelect = new SearchAdapterMultiSelect(MultipleSelectGroup.this, totalFeeds);
