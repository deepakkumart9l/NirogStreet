...
public class ChipCloud implements View.OnClickListener {
    ...
    public void delchip(final int index, String name) {
        for (int i = 0; i < layout.getChildCount(); i++) {
            final ToggleChip deletedChip = (ToggleChip) layout.getChildAt(i);
            if (deletedChip.getText().toString().equalsIgnoreCase(name)) {
